					...
					<div class="col-md-12">
						<div class="row">
							...
							<div class="form-group col-md-4">
								...
								<select name="customer_type" id="" class="custom-select">
								    <option value="Retailer" <?php echo isset($meta['customer_type']) && $meta['customer_type']? 'selected': '' ?>>Retailer</option>
				                    <option value="Wholesale" <?php echo isset($meta['customer_type']) && $meta['customer_type']? 'selected': '' ?>>Wholesale</option>
								</select>							
							</div>
						</div>
						<hr>
						<div class="row mb-3">
								...
								<div class="col-md-3">
									...
									<button class="btn btn-block btn-sm btn-dark" type="button" id="add_list"><i class="fa fa-plus"></i> Add to List</button>
								</div>
									...
									?>
										<tr class="item-row">
											<td>
												...
												<p class="pname"><b>Name: </b><?php echo $prod[$row['product_id']]['name'] ?></p>
												<p class="pdesc"><small><b>Description: </b><i><?php echo $prod[$row['product_id']]['description'] ?></i></small></p>
											</td>
											<td>
											...
											<td class="text-center" id="trash">
											    <!-- <button class="btn btn-sm btn-danger" id="delete" onclick = "rem_list($(this))"><i class="fa fa-trash"></i></button> -->
											</td>
										</tr>
									<?php endwhile; ?>
									<?php endif; ?>
					    ...
					    <div class="modal-dialog modal-md" role="document">
					        <div class="modal-content">
					            <div class="modal-header">
					                <h6 class="modal-title"><b>Paying Form</b></h6>
					            </div>
...
<div id="tr_clone">
	...
	<tr class="item-row">
		...
		<td>
			<input type="number" min="1" step="any" name="qty[]" value="" class="text-right" style="border: 0;" readonly="">
		</td>
		<td>
